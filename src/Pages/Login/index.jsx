        ...
        <div className={stil.box}>
          <div className={stil.boxWrapper}>
            <div className={stil.logo}>
              ...
              <p className={stil.pText}>Enter your email and password to sign in</p>
            </div>
            <form className={stil.form} onSubmit={handleSubmit}>
              <div className={stil.emailDiv}>
                ...
                />
                {errors.email && <p className={stil.errorText}>{errors.email}</p>}
              </div>
              <div className={stil.passwordDiv}>
                ...
                />
                {errors.password && <p className={stil.errorText}>{errors.password}</p>}
              </div> 
             <Stack className={stil.Stack} direction="row" spacing={1} alignItems="center">
           <AntSwitch defaultChecked inputProps={{ 'aria-label': 'ant design' }} />
           <Typography className={stil.lastText}>Remember me</Typography>
            </Stack>
              <button 
               className={stil.submitBtn} type="submit">
                Sign in
              </button>
            </form>
